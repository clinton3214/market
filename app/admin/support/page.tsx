          ...
          <div className="mb-4 space-y-3">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-secondary border border-border rounded-xl pl-9 pr-4 py-2 text-xs text-foreground placeholder-muted-foreground focus:outline-none focus:border-purple-500"
              />
            </div>
          </div>
        ...
        <div className="lg:col-span-7 bg-secondary/30 rounded-2xl border border-border p-4 flex flex-col h-full overflow-hidden shadow-xl">
          {activeConversationId ? (
            <>
                    ...
                    >
                      <div
                        className={`max-w-[85%] px-4 py-3 rounded-2xl text-xs sm:text-sm leading-relaxed border transition-all ${
                          m.sender === 'admin'
                            ? 'bg-purple-600 text-white border-purple-500/40 rounded-br-xs shadow-md shadow-purple-500/20'
              ...
              {/* Floating Pill Glass Input */}
              <div className="mt-4 pt-2">
                <div className="relative flex items-center gap-3 bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 border border-purple-500/30 rounded-full p-2 px-5 shadow-lg transition-all focus-within:border-purple-400/60 focus-within:ring-2 focus-within:ring-purple-500/20">
                  
                  <button type="button" className="text-muted-foreground hover:text-purple-400 transition-colors p-1">
                  ...
                  <input
                    ...
                    className="flex-1 bg-transparent border-none px-2 py-2 text-sm text-foreground placeholder-muted-foreground focus:outline-none focus:ring-0"
                  />

                  <button
                    onClick={handleSendReply}
                    disabled={!replyText.trim() || sendingReply}
                    className="w-10 h-10 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 hover:opacity-90 disabled:opacity-40 text-white flex items-center justify-center transition-all shadow-lg shrink-0"
                  >
